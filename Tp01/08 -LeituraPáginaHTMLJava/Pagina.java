       ...
       int x25 = 0;
        for(int i = 0;i<conteudo.length();i++){
            ...
            if(conteudo.charAt(i) == '<'){
                ...
                if(conteudo.charAt(i+2)=='t' && conteudo.charAt(i+3) == 'a' && conteudo.charAt(i+4) =='b' && conteudo.charAt(i+5)=='l' && conteudo.charAt(i+6)=='e' && conteudo.charAt(i+8)=='>' ){
                    x25++;
                    i+=8;

                }
                else if(conteudo.charAt(i+2)=='b' && conteudo.charAt(i+3)=='r' && conteudo.charAt(i+5)=='>'){
                    x24++;
                    i+=5;
                }
        ...
        System.out.printf("a(%d) e(%d) i(%d) o(%d) u(%d) á(%d) é(%d) í(%d) ó(%d) ú(%d) à(%d) è(%d) ì(%d) ò(%d) ù(%d) ã(%d) õ(%d) â(%d) ê(%d) î(%d) ô(%d) û(%d) consoantes(%d) < br >(%d) < table >(%d) %s\n",x1,x2,x3,x4,x5,x6,x7,x8,x9,x10,x11,x12,x13,x14,x15,x16,x17,x18,x19,x20,x21,x22,x23,x24,x25,serie);
