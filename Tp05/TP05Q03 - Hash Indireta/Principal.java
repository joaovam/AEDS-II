...
public class Principal{
	   ...
	   public static HashIndiretoLista hash;
	   public static int comp = 0;
		...
		public static void criaLog(long tempo){
			...
			Arq.openWrite("698159_hashIndireta.txt");
        ...
        public static void main(String[] Args)throws Exception{
            ...
            while(!isFim(palavra)){
                ...
                hash.inserirInicio(jogadores[posicao]);
...
class Lista {
   ...
   public int tamanho() {
    ...
    /**
    	Classe Hash indireto com lista adapatada para jogadores
    **/
