...
public class Principal{
	   ...
	   public static ArvoreBinariaAltura arvoreBinaria;
	   public static int comp = 0;
		...
		public static void criaLog(long tempo){
			...
			Arq.openWrite("698159_arvoreArvore.txt");
        ...
        public static void main(String[] Args)throws Exception{
			...
			arvoreBinaria = new ArvoreBinariaAltura();
 ...
 * @author Max do Val Machado
 */
class ArvoreBinariaAltura {
	private No raiz; // Raiz da arvore.

	/**
	 * Construtor da classe.
	 */
	public ArvoreBinariaAltura() throws Exception {
		inserirInicial();
	}
	...
	public void inserirInicial() throws Exception {
		raiz = inserirInicial(7, raiz);
		raiz = inserirInicial(3, raiz);
		raiz = inserirInicial(11, raiz);
		raiz = inserirInicial(1, raiz);
		raiz = inserirInicial(5, raiz);
		raiz = inserirInicial(9, raiz);
		raiz = inserirInicial(12, raiz);
		raiz = inserirInicial(0, raiz);
		raiz = inserirInicial(2, raiz);
		raiz = inserirInicial(4, raiz);
		raiz = inserirInicial(6, raiz);
		raiz = inserirInicial(8, raiz);
		raiz = inserirInicial(10, raiz);
		raiz = inserirInicial(13, raiz);
		raiz = inserirInicial(14, raiz);
	 ...
	 */
	private No inserirInicial(int x, No i) throws Exception {
		if (i == null) {
         i = new No(x);

      } else if (x < i.elemento) {
         i.esq = inserirInicial(x, i.esq);

      } else if (x > i.elemento) {
         i.dir = inserirInicial(x, i.dir);
	...
	private void caminharPre(No i) {
		if (i != null) {
			MyIO.println(i.elemento); // Conteudo do no.
...
/**
	Segunda arvoreBinaria, chave de pesquisa = nome do jogador
**/
class ArvoreBinariaNome {
	 ...
	 * @throws Exception Se o elemento existir.
	 */
	private void inserirPai(Jogador x, No2 i, No2 pai) throws Exception {
		if (i == null) {
	 ...
	 * @throws Exception Se nao encontrar elemento.
	 */
	private No2 remover(Jogador x, No2 i) throws Exception {
	 ...
	 * @throws Exception Se nao encontrar elemento.
	 */
	private void remover2(Jogador x, No2 i, No2 pai) throws Exception {
		if (i == null) {
         throw new Exception("Erro ao remover2!");
      } else if (x.getNome().compareTo(i.elemento.getNome()) < 0) {
         remover2(x, i.esq, i);
   ...
   public static boolean igual (ArvoreBinariaNome a1, ArvoreBinariaNome a2){
      return igual(a1.raiz, a2.raiz);
   }

   private static boolean igual (No2 i1, No2 i2){
      boolean resp;
      if(i1 != null && i2 != null){
   ...
   public int quantidadePares(No2 i){
      int resp = 0;
      if(i != null){
