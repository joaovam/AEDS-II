    ...
    public class Principal{
	   ...
	   protected static int comp;
        ...
        public static void criaLog(long tempo){
			...
			Arq.openWrite("698159_insercao.txt");
        ...
        public static boolean comparaJogadores(int j,Jogador tmp){
        	...
        	comp++;
        	return (j >= 0)&&((novoVetor[j].getAnoNascimento()>tmp.getAnoNascimento())||(novoVetor[j].getAnoNascimento()==tmp.getAnoNascimento()&&novoVetor[j].getNome().compareTo(tmp.getNome())>0));
